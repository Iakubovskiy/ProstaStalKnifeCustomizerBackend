...
{
    public class EngravingRepository : Repository<Engraving, int>
    {
        ...
        public async Task<Engraving> GetById(int id)
        {
        ...
        public async Task<Engraving> Update(int id, Engraving newEngraving)
        {
